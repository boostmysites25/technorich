      ...
      <div className="bg-secondary/5 relative text-primary_text">
        <div className="py-[5rem] flex flex-col gap-5 items-center wrapper">
          ...
          {!isLoading && !error && blogs.length === 0 && (
            <div className="mt-[2rem] w-full text-center">
              <p className="text-lg">No blogs found. Check back later for new content!</p>
            </div>
          )}
...
export const BlogItem = ({ blog }) => {
  const formattedDate = new Date(blog.publishDate || blog.createdAt).toLocaleDateString('en-US', {
    year: 'numeric',
    month: 'long',
    day: 'numeric'
  });
