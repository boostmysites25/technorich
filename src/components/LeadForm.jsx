  ...
  return (
    <div className="flex flex-col gap-4 py-[5rem] px-5 bg-primary/5">
      ...
      <p data-aos="fade-up" className="desc text-center max-w-[55rem] mx-auto">
        If you’re ready to get started, we’d love to discuss how we can bring
        your project to life. Fill out the form below with some details, and one
        of our experts will reach out to you soon.
      </p>
      <form
