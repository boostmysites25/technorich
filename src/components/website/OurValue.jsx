        ...
        <div className="flex flex-col items-start gap-5">
          ...
          <div data-aos="fade-up" className="flex gap-5 mt-2">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="desc">
                Embracing creativity, pushing boundaries, and delivering exceptional
                results.
              </p>
            </div>
          </div>
          <div data-aos="fade-up" className="flex gap-5">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="desc">
                We operate with honesty, transparency, and accountability. We value
                ethical practices and strive for open communication within our
